...
def resolve_inputs(**context) -> None:
    ...
    ti.xcom_push(key="traj",value=traj) #what was it that the bash operator expects here? TODO: find that out and definitely don't just leave it like this", value=traj)
